...
.. _actors-timers-scala:

Timers, scheduled messages
==========================

Messages can be scheduled to be sent at a later point by using the :ref:`scheduler-scala` directly,
...
.. includecode:: code/docs/actor/TimerDocSpec.scala#timers
